...
public class GalaxyService {
    ...
    public GalaxyService() {
        ...
        theEmpireStrikesBack.setDirector("GeorgeLucas");
        ...
        luke.getEpisodeIds().addAll(List.of(4, 5, 6));
        ...
        leia.getEpisodeIds().addAll(List.of(4, 5, 6));
        ...
        vader.getEpisodeIds().addAll(List.of(4, 5, 6));
    ...
    public Uni<Film> getFilm(int id) {
